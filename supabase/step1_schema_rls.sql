...
create table if not exists public.job_seeker_profiles (
  ...
  airframe_scope text not null default 'Fixed Wing',
...
create table if not exists public.employer_profiles (
  ...
  notify_on_new_non_rejected_application boolean not null default true,
  notify_on_application_status_changes boolean not null default false,
